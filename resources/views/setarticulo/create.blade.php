...
@section('content_header')
    ...
    @if(count(Cart::getContent()))
         <a href="{{route('cart.checkout')}}"> Ver Set Articulo <span class="badge badge-danger">{{count(Cart::getContent())}}</span></a>
         @endif
    </div>
@stop
...
@section('content_header')
 ...
 <form action="/setarticulos" method="POST">
    ...
    <div class="mb-3"> 
      ...
      <input  id="categoria" name="categoria" type="text" class="form-control" tabidex="2">
      </div>

      <div class="mb-3"> 
      <label for="" class="form-label">Puesto</label>
      <input  id="puesto" name="puesto" type="text" class="form-control" tabidex="3">
      </div>

      <div class="mb-3"> 
       <label for="" class="form-label">Cantidad</label>
       <input  id="cantidad" name="cantidad" type="text" class="form-control" tabidex="4">
       </div>
...
<a href="/setarticulos" class="btn btn-primary" tabindex="7">Cancelar</a>
