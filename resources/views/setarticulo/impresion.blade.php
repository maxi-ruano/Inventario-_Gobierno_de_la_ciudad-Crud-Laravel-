...
@section('content_header')
    <h1>IMPRESION DE CODIGO DE LOS ARTICULOS</h1>
@stop

@section('content')

<form action="{{ route('setarticulo.imprimirBarra')}}" method="GET" id="form1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><center>{{$setarticulo->sede}}  {{$setarticulo->sector}}<br>{{$setarticulo->puesto}} <br>
                      ...
                      {!! DNS1D::getBarcodeSVG($setarticulo->codigo,'C128C') !!}
                     <div class="checkbox">
                    <label>
                        <input type="checkbox" name="set_articulos[]" value ="{{$setarticulo}}">
