        ...
        <tbody>
            @foreach ($gabinetes as $gabinete)
                <tr>
                    ...
                    <td>{{ $gabinete->id }}</td>
                    <td>{{$gabinete->id_setarticulo}}</td>
                    <td>{{ $gabinete->codigo }}</td>
                    <td>{{ $gabinete->serial}}</td>
                   <td>{{$gabinete->estante }}</td> 
                    <td>{{$gabinete->faja}}</td>
                    <td>{{$gabinete->precinto }}</td>
                    ...
                    <td>
                                ...
                                <a href="/gabinetes/{{ $gabinete->id }}/editcart" class="btn btn-secondary"><i
                                    class="fa fa-shopping-cart"></i></a>
                        @can('articulo.show')
                            <a href="{{ route('gabinetes.show', $gabinete->id) }}" class="btn btn-info"><i
                                    class="fas fa-info-circle"></i></a>
                        @endcan
                        
                        <a href="/gabinetes/{{$gabinete->id}}/edit" class="btn btn-primary" ><i class="far fa-edit"></i></a>
                        
                        
                        <form action="{{ route('gabinetes.destroy', $gabinete->id) }}" class="formulario-eliminar"
                            method="POST">
            ...
            @endforeach
            <a href="{{ route('gabinete.impresion3') }}" class="btn btn-success mb-3"> Seleccionar Etiquetas</a>
